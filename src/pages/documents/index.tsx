import { projectsGlobalHeadingDescription, projectsGlobalHeadingTitle } from '@/components/Content'
...
const Projects = () => {
    return (
        <>
            <Head>
                <title>Capital Cortex | Documents</title>
            ...
            <LayoutUser>
                <section className='py-4 sm:py-12'>
                    <div className="theme-container">
                        <GlobalHeadingSection title={projectsGlobalHeadingTitle} description={projectsGlobalHeadingDescription} />
                        <DocumentsModule />
                    </div>
                </section>
            </LayoutUser>
